...
#ifndef ARDUINO_INTERFACES__SRV__SET_JOINT_POSITIONS_H_
#define ARDUINO_INTERFACES__SRV__SET_JOINT_POSITIONS_H_
...
#endif  // ARDUINO_INTERFACES__SRV__SET_JOINT_POSITIONS_H_
